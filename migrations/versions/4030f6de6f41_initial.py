...
Revision ID: 4030f6de6f41
Revises: 
Create Date: 2025-04-16 16:14:26.342636
...
def upgrade():
    ...
    sa.Column('estimated_engagement', sa.String(length=20), nullable=True),
    ...
    sa.Column('related_topics', sa.String(length=255), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    with op.batch_alter_table('calendar_post', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_calendar_post_user_id'), ['user_id'], unique=False)
    ...
    op.create_table('saved_content_idea',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('idea_id', sa.Integer(), nullable=True),
    sa.Column('saved_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['idea_id'], ['content_idea.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'idea_id', name='uix_user_idea')
    )
    with op.batch_alter_table('saved_content_idea', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_saved_content_idea_idea_id'), ['idea_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_saved_content_idea_user_id'), ['user_id'], unique=False)
    ...
    sa.Column('followers_goal', sa.Integer(), nullable=True),
    sa.Column('engagement_goal', sa.Float(), nullable=True),
    ...
    with op.batch_alter_table('social_page_growth', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_social_page_growth_is_goal'), ['is_goal'], unique=False)
        batch_op.create_index(batch_op.f('ix_social_page_growth_platform'), ['platform'], unique=False)
        batch_op.create_index(batch_op.f('ix_social_page_growth_social_page_id'), ['social_page_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_social_page_growth_user_id'), ['user_id'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('social_page_growth', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_social_page_growth_user_id'))
        batch_op.drop_index(batch_op.f('ix_social_page_growth_social_page_id'))
        batch_op.drop_index(batch_op.f('ix_social_page_growth_platform'))
        batch_op.drop_index(batch_op.f('ix_social_page_growth_is_goal'))
    ...
    with op.batch_alter_table('saved_content_idea', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_saved_content_idea_user_id'))
        batch_op.drop_index(batch_op.f('ix_saved_content_idea_idea_id'))

    op.drop_table('saved_content_idea')
    op.drop_table('plan_feature')
    op.drop_table('organization')
    with op.batch_alter_table('calendar_post', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_calendar_post_user_id'))

    op.drop_table('calendar_post')
    op.drop_table('user')
    op.drop_table('trend')
    with op.batch_alter_table('social_page_category', schema=None) as batch_op:
